...
- `data/washington-dc/current-weekend.json` (Greater Washington DC: DC, Northern Virginia, suburban Maryland)

A Wednesday publication replaces all four files in one tested Git commit.
